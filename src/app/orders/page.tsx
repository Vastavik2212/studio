  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container px-4 py-8">
        ...
        <h1 className="font-headline text-4xl lg:text-5xl font-bold mb-8 text-center">Your Orders</h1>
        {orders.length === 0 ? (
          <div className="text-center py-16">
            <p className="text-lg text-muted-foreground mb-4">You haven't ordered any cakes yet.</p>
            <Button asChild>
